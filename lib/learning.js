...
function createLearningClient(opts) {
  ...
  const DEFAULT_GROUPS = [
    ...
    {
      GROUP_ID: 'practice-fieldwork',
      LABEL: 'Practice & Fieldwork',
      DESCRIPTION: 'How the systems in this fleet actually run in practice -- runbooks, deploy and launch procedures, incidents and what they taught, and the operational detail a session only learns by doing the work. Distinct from Systems & Architecture, which is the conceptual material: that track is how systems are designed and why they break at scale, this one is what running these specific systems is actually like.',
      ICON: '🛠️',
      COLOR: '#f97316',
      STATUS: 'active',
      SORT_ORDER: '9',
