...
module.exports = {
  ...
  capabilities: [
    ...
    { name: 'study.courses', method: 'GET', path: '/learning', description: 'Course catalogue with lessons, intelligent groups, review dates, versions, and relevance.' },
    { name: 'study.groups.list', method: 'GET', path: '/learning/groups', description: 'Intelligent learning tracks and group list with aggregated progress.' },
    { name: 'study.group.save', method: 'POST', path: '/learning/group', description: 'Create or update a learning group / classification.' },
    { name: 'study.group.archive', method: 'POST', path: '/learning/group/archive', description: 'Archive or restore a learning group.' },
    { name: 'study.course.status', method: 'POST', path: '/learning/course/status', description: 'Update course status (active/archived/disabled) or reassign group.' },
    { name: 'study.module.meta', method: 'POST', path: '/learning/module/meta', description: 'Update module relevance, version, date reviewed, or status.' },
    { name: 'study.lesson', method: 'GET', path: '/learning/lesson', description: 'One lesson\'s content.' },
    { name: 'study.note.get', method: 'GET', path: '/learning/notes', description: 'Read a lesson\'s margin note.' },
    { name: 'study.note.save', method: 'POST', path: '/learning/notes', description: 'Save a lesson\'s margin note.' },
    { name: 'study.resume', method: 'POST', path: '/learning/resume', description: 'Save reading position.' },
    { name: 'study.progress', method: 'POST', path: '/learning/progress', description: 'Mark a lesson\'s progress.' },
    { name: 'study.contributions', method: 'GET', path: '/learning/contributions', description: 'Learning activity heatmap.' },
    { name: 'study.campus', method: 'GET', path: '/learning/campus', description: 'Standing advice on what to read next -- priority bands (Read now/This week/Before the room/When it comes up/Background) from hand-authored learning/campus.tsv rows, falling back to a computed next-step (resume point, then next unfinished module per course) when nothing is curated.' },
    { name: 'study.prime', method: 'GET', path: '/learning/prime', description: 'Most relevant lesson in the vault for a task, by keyword overlap (no model call) -- powers the task-detail "Prime me" card.' },
    { name: 'study.manifest', method: 'GET', path: '/learning/manifest', description: 'Manifest of all learning modules with versions and revisions for offline prefetch.' },
    { name: 'study.parseMd', method: 'POST', path: '/learning/parse-md', description: 'BL26082601 -- parse learning markdown into a canonical JSON block-tree (equations, charts, maps, callouts, tables, etc.).' },
