...
module.exports = {
  ...
  capabilities: [
    ...
    { name: 'ai.chat.complete', method: 'POST', path: '/ai/chat', description: 'FI26090501 -- one Groq-backed chat-completion call ({messages:[{role,content}]} -> {response}). Called by hub for the webconsole Chat panel; caller owns conversation history/threading.' },
  ],
